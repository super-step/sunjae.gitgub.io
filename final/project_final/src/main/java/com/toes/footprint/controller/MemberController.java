...
//	추가목록:
//	membercontroller(2개), PostService(인터페이스)(1개), PostServiceImplV1(1개) ,
//	PostDao(1개), post-mapper(1개), include-header(1개), include-head-member-mypage.jsp 만듬, mypage_postmanager.jsp만듬
//	
