...
//	메인화면
	...
	public String home(@ModelAttribute("MEMBER") MemberDto memberDto, HttpSession httpSession) {
//		memberDto = (MemberDto) httpSession.getAttribute("MEMBERLOGIN");
		memberDto = (MemberDto) httpSession.getAttribute("MEMBERLOGIN");
		log.debug("홈화면 {}",memberDto.toString());
		return "/member/home";
	}
...
//			별 일이 없는 이상 내역이 삭제되지 않음 
			log.debug("로그인 완료 {}", resultDto.toString());
			httpSession.setAttribute("MEMBERLOGIN", resultDto);
			return "redirect:/";
		} catch (Exception e) {
	...
	public String loginmodal(@RequestParam(name = "ERROR", required = false) String errorMessage,
			@ModelAttribute("MEMBER") MemberDto memberDto, Model model, SessionStatus sessionStatus,
...
//	 마이페이지
	...
	public String mypage(@ModelAttribute("MEMBER") MemberDto memberDto, HttpSession httpSession) {
...
//	 마이페이지
	...
	public String mypage(@ModelAttribute("MEMBER") MemberDto memberDto, Model model, HttpSession httpSession) {
