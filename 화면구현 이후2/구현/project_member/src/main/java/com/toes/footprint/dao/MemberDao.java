...
//	마이페이지 정보 수정
//	@Update("UPDATE tb_member SET mb_seq = #{mb_seq}, mb_password = #{mb_password},"
//		+	"	mb_nick = #{mb_nick}, "
//		+		"mb_proimg = #{mb_proimg},"
//		+		"mb_name = #{mb_name},"
//		+	"	mb_birth = #{mb_birth},"
//		+		" mb_tel = #{mb_tel},"
//		+	"	mb_email = #{mb_email},"
//		+		" mb_addr = #{mb_addr} WHERE mb_id = #{mb_id} ")
//	public int update(MemberDto memberDto);

	@Update("UPDATE tb_member SET mb_seq = #{mb_seq}, mb_password = #{mb_password}, mb_nick = #{mb_nick}, "
	           + "mb_proimg = #{mb_proimg}, mb_name = #{mb_name}, mb_birth = #{mb_birth}, mb_tel = #{mb_tel}, "
	           + "mb_email = #{mb_email}, mb_addr = #{mb_addr} WHERE mb_id = #{mb_id}")
